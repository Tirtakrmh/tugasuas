...
public class KaryawanHonorer extends KaryawanTetap{
    ...
    private static final int golA = 30_000_000;
    private static final int golB = 20_000_000;
    private static final int golC = 10_000_000;

    public KaryawanHonorer(String namaPeminjam, String nikPeminjam) {
        super(namaPeminjam, nikPeminjam);
    }
